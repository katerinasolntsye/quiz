  ...
  <header>
      ...
      style="position:fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(255, 255, 255, 0.88); z-index: 920;"></div>
                        ...
                        <form class="pop-up" v-if="showPopupLogin">
                            ...
                            <input type="text" v-model="userEmail" placeholder="Ваш e-mail" autocomplete="email" :class="{ errored: emailError }">
                            </label>
                            <!-- <label for=""> -->
                            <label>
                            <!-- <p>Пароль:</p> -->
                            <!-- <input type="password" name="" id="" v-model="userPassword1" placeholder="•••••••••" :class="{ errored: password1Error }"> -->
                            <input type="password" v-model="userPassword1" placeholder="•••••••••" autocomplete="current-password" :class="{ errored: password1Error }">
                            </label>
                        ...
                        <form class="pop-up" v-if="showPopupSignup">
                            ...
                            <input type="text" v-model="userName" placeholder="Ваше имя" autocomplete="given-name" :class="{ errored: nameError }">
                            </label>
                            <!-- <label for=""> -->
                            <label>
                            <!-- <p>E-mail:</p> -->
                            ...
                            <input type="password" v-model="userPassword1" placeholder="•••••••••" autocomplete="new-password" :class="{ errored: password1Error }">
                            <input type="password" v-model="userPassword2" placeholder="Подтвердите Ваш пароль" autocomplete="new-password" :class="{ errored: password2Error }">
                            </label>
                            </div>
                            <p v-if="$store.getters.getLoginErrored">Неверный логин и/или пароль.</p>
...
export default {
  ...
  methods: {
    ...
    //   console.log(user);
        ...
        // fetch("https://httpbin.org/get", requestOptions)
