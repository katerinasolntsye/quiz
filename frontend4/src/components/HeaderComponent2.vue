            ...
            <div id="header_menu">
                <div id="header_menu_content">
                    <div id="header_right">
                        ...
                        <!-- <router-link id="header_right_text" to="/student" target="_blank">Курсы</router-link> -->
                        <router-link id="header_right_text" to="/student">Курсы</router-link>
                    </div>
                    <div id="header_left">
                        <!-- <a class="header_left_text" href="profile.html">Профиль</a> -->
                        <router-link class="header_left_text" to="/student/profile">Профиль</router-link>
                        <span @click="showPopupLogin=true; $store.commit('logout')" class="header_left_text header_top_text">
