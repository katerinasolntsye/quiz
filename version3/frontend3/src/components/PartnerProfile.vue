<template>
  ...
  <!-- <HeaderComponent1 /> -->
  <main>
      <h1>Профиль PartnerProfile</h1>
		<h2>Основная информация</h2>
		<div v-if="saveData1">
			<table>
				<tr>
					<td>Имя</td>
					<td>{{$store.getters.getPartner.name}}</td>
				</tr>
				<tr>
					<td>Фамилия</td>
					<td>{{$store.getters.getPartner.surname}}</td>
				</tr>
				<tr>
					<td>Дата рождения</td>
					<td>{{$store.getters.getPartner.birthdate}}</td>
				</tr>
				<tr>
					<td>Страна</td>
					<td>{{$store.getters.getPartner.country}}</td>
				</tr>
				<tr>
					<td>Город</td>
					<td>{{$store.getters.getPartner.city}}</td>
				</tr>
			</table>
			<div>
		...
		<form name="main-info" v-if="editData1">
            ...
            <div>
                <button class="profile_button" type="button" @click="saveDataPartner()">Сохранить</button>
				<button class="profile_button" style="margin: 0;" @click.prevent="cancelDataPartner()">Отменить</button>
            </div>
		</form>
		...
		<div v-if="saveData2">
			<table>
				<tr>
					<td>E-mail</td>
					<td>{{$store.getters.getPartner.email}}</td>
				</tr>
				<tr>
					<td>Телефон</td>
					<td>{{$store.getters.getPartner.tel}}</td>
				</tr>
				<tr>
					<td>Пароль</td>
					<td>•••••••••</td>
		...
		<form name="partner-login-data" v-if="editData2">
			<div class="profile_text">
                <label>E-mail</label>
            ...
            <div>
                <button class="profile_button" type="button" @click="saveDataPartnerLogin()">Сохранить</button>
				<button class="profile_button" style="margin: 0;" @click.prevent="cancelDataPartnerLogin()">Отменить</button>
            </div>
        </form>
		...
		<table class="social">
			<tr>
				...
				<td class="social-name">{{$store.getters.getPartner.google}}</td>
			...
			<tr>
				...
				<td class="social-name" hidden>{{$store.getters.getPartner.vkontakte}}</td>
			...
			<tr>
				...
				<td class="social-add">Привязать</td>
				<td class="social-name" hidden>{{$store.getters.getPartner.telegram}}</td>
				<td class="social-delete" title="Удалить" hidden>&times;</td>
			</tr>
		</table>
		<h2>Информация о подписках</h2>
		<!-- <table class="courses">
			<tr v-for="c in JSON.parse($store.getters.getPartner.payedcourses)" :key="c.title">
				<td>{{c.title}}</td>
