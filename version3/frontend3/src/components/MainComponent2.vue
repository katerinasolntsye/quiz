<template>
  ...
  <main>
      ...
      <h1>Список курсов</h1>
      <h2>Мои курсы:</h2>
        <!-- <router-link class="lessons_menu" to="/student-phonetics1-lessons">Фонетика и правила чтения. Часть 1</router-link>
        <br />
        <router-link :disabled="courseSelected" class="lessons_menu" to="/student-phonetics2-lessons">Фонетика и правила чтения. Часть 2</router-link> -->
      <p>
      ...
      courses: [
        {
          ...
          link1: "/student-phonetics1-lessons",
          link2: "/",
        },
        {
          title: "\nФонетика и правила чтения. Часть 2",
          link1: "/student-phonetics2-lessons",
          link2: "/",
        },
      ],
    }
