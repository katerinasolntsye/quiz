...
const routes = [{
    ...
    {
        path: '/student/phonetics1',
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            // if (store.getters.getUserLoggedin || window.$cookies.get("name")) { return next(); } else { console.log(window.$cookies.get("name")); return false }
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics1')) { return next(); } else { console.log(window.$cookies.get("name")); return next('/'); }
        },
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            // if (store.getters.getUserLoggedin || window.$cookies.get("name")) { return next(); } else { console.log(window.$cookies.get("name")); return false }
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics1') && JSON.parse(store.getters.getUser.payedcourses)[0].lessons[0].unlocked == true) { return next(); } else { console.log(window.$cookies.get("name")); return false }
        },
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            // if (store.getters.getUserLoggedin || window.$cookies.get("name")) { return next(); } else { console.log(window.$cookies.get("name")); return false }
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics1') && JSON.parse(store.getters.getUser.payedcourses)[0].lessons[1].unlocked == true) { return next(); } else { console.log(window.$cookies.get("name")); return false }
        },
    ...
    {
        path: '/student/phonetics2',
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            // if (store.getters.getUserLoggedin || window.$cookies.get("name")) { return next(); } else { console.log(window.$cookies.get("name")); return false }
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics2')) { return next(); } else { console.log(window.$cookies.get("name")); return next('/'); }
        },
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            // if (store.getters.getUserLoggedin || window.$cookies.get("name")) { return next(); } else { console.log(window.$cookies.get("name")); return false }
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics2') && JSON.parse(store.getters.getUser.payedcourses)[0].lessons[0].unlocked == true) { return next(); } else { console.log(window.$cookies.get("name")); return false }
        },
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
            window.scrollTo(0, 0);
            if ((store.getters.getUserLoggedin || window.$cookies.get("name")) && JSON.parse(store.getters.getUser.payedcourses).some(course => course.link == '/student/phonetics2') && JSON.parse(store.getters.getUser.payedcourses)[0].lessons[1].unlocked == true) { return next(); } else { console.log(window.$cookies.get("name")); return false }
        },
