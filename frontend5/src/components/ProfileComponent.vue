      ...
      <h1>Профиль</h1>
		...
		<div v-if="saveMainData">
			<table>
				<tr>
					...
					<td :class="{ 'grey-italic' : ($store.getters.getUser.username=='') }">{{$store.getters.getUser.username==""?"Не заполнено":$store.getters.getUser.username}}</td>
				</tr>
				<tr>
					<td>Фамилия</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.surname=='') }">{{$store.getters.getUser.surname==""?"Не заполнено":$store.getters.getUser.surname}}</td>
				</tr>
				<tr>
					<td>Дата рождения</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.birthdate=='') }">{{$store.getters.getUser.birthdate==""?"Не заполнено":$store.getters.getUser.birthdate}}</td>
				</tr>
				<tr>
					<td>Страна</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.country=='') }">{{$store.getters.getUser.country==""?"Не заполнено":$store.getters.getUser.country}}</td>
				</tr>
				<tr>
					<td>Город</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.city=='') }">{{$store.getters.getUser.city==""?"Не заполнено":$store.getters.getUser.city}}</td>
				</tr>
			</table>
			<div>
		...
		<div v-if="saveLoginData">
			<table>
				<tr>
					<td>E-mail</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.email=='') }">{{$store.getters.getUser.email==""?"Не заполнено":$store.getters.getUser.email}}</td>
				</tr>
				<tr>
					<td>Телефон</td>
					<td :class="{ 'grey-italic' : ($store.getters.getUser.tel=='') }">{{$store.getters.getUser.tel==""?"Не заполнено":$store.getters.getUser.tel}}</td>
				</tr>
				<tr>
					<td>Пароль</td>
					<td>•••••••••</td>
		...
		<form name="login-data" v-if="editLoginData">
			<div class="profile_text">
                <label>E-mail</label>
		...
		<table class="social">
			<tr>
				...
				<td class="social-add" v-if="$store.getters.getUser.google == ''">Привязать</td>
				<td class="social-name" v-if="$store.getters.getUser.google != ''">{{$store.getters.getUser.google}}</td>
				<td class="social-delete" title="Удалить" v-if="$store.getters.getUser.google != ''" @click="deleteUserGoogle()">&times;</td>
			</tr>
			<tr>
				<td></td>
				<td>
				...
				<td class="social-add" v-if="$store.getters.getUser.vkontakte == ''">Привязать</td>
				<td class="social-name" v-if="$store.getters.getUser.vkontakte != ''">{{$store.getters.getUser.vkontakte}}</td>
				<td class="social-delete" title="Удалить" v-if="$store.getters.getUser.vkontakte != ''" @click="deleteUserVkontakte()">&times;</td>
			</tr>
			<tr>
				<td></td>
				<td>
				...
				<td class="social-add" v-if="$store.getters.getUser.telegram == ''">Привязать</td>
				<td class="social-name" v-if="$store.getters.getUser.telegram != ''">{{$store.getters.getUser.telegram}}</td>
				<td class="social-delete" title="Удалить" v-if="$store.getters.getUser.telegram != ''" @click="deleteUserTelegram()">&times;</td>
			</tr>
		</table>
...
export default {
  ...
  methods: {
	...
	deleteUserGoogle() {
		this.$store.state.user = JSON.parse(localStorage.getItem("user"));
		this.$store.commit('deleteUserGoogle');
		localStorage.setItem("user", JSON.stringify(this.$store.getters.getUser));
	},
	deleteUserVkontakte() {
		this.$store.state.user = JSON.parse(localStorage.getItem("user"));
		this.$store.commit('deleteUserVkontakte');
		localStorage.setItem("user", JSON.stringify(this.$store.getters.getUser));
	},
	deleteUserTelegram() {
		this.$store.state.user = JSON.parse(localStorage.getItem("user"));
		this.$store.commit('deleteUserTelegram');
		localStorage.setItem("user", JSON.stringify(this.$store.getters.getUser));
	},
  }
}
