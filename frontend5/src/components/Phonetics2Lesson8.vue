<template>
  <div class="main">
  <main>
      <h1>Урок 8. Буквы Pp, Qq, Rr, Ss, Tt</h1>
        ...
        <div id="start-cards-1" :class="openedtaskclass(1)">
          <p>Карточки 1
            ...
            <span class="task-done-counter" :class="showtaskcounter(1)">Выполнено <b>{{ JSON.parse($store.getters.getUser.payedcourses)[1].lessons[7].tasks[0].completations }}</b> из <b>{{ JSON.parse($store.getters.getUser.payedcourses)[1].lessons[7].tasks[0].goal }}</b> раз</span>
...
export default {
  ...
  mounted() {  
    document.title = "FullEng – Урок 8. Буквы Pp, Qq, Rr, Ss, Tt";
