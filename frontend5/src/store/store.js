...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        setUserPayedcourses(state, newValue) {
            state.user.payedcourses = newValue;
        },
        ...
        deleteUserGoogle(state) {
            state.user.google = "";
        },
        deleteUserVkontakte(state) {
            state.user.vkontakte = "";
        },
        deleteUserTelegram(state) {
            state.user.telegram = "";
        },
        setUserCompletedcourses(state) {
        ...
        setPartnerPatronymic(state, newValue) {
            state.partner.patronymic = newValue;
        },
        ...
        deletePartnerGoogle(state) {
            state.partner.google = "";
        },
        deletePartnerVkontakte(state) {
            state.partner.vkontakte = "";
        },
        deletePartnerTelegram(state) {
            state.partner.telegram = "";
        },
        setPartnerLegal(state, newValue) {
            state.partner.legal = newValue;
        },
        setPartnerSeries(state, newValue) {
            state.partner.series = newValue;
        },
        setPartnerNumber(state, newValue) {
            state.partner.number = newValue;
        },
        setPartnerIssued(state, newValue) {
            state.partner.issued = newValue;
        },
        setPartnerIssuedDate(state, newValue) {
            state.partner.issueddate = newValue;
        },
        setPartnerTin(state, newValue) {
            state.partner.tin = newValue;
        },
        setPartnerCardNumber(state, newValue) {
            state.partner.cardnumber = newValue;
        },
        setPartnerAccountNumber(state, newValue) {
            state.partner.accountnumber = newValue;
        },
        setPartnerBankid(state, newValue) {
            state.partner.bankid = newValue;
        },
        setPartnerRecipientBank(state, newValue) {
            state.partner.recipientbank = newValue;
        },
    },
    getters: {
